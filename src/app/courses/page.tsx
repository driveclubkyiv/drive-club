        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Програми навчання водіїв
            </h1>
            <p className="text-xl md:text-2xl text-orange-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Професійна підготовка від базових навичок до спеціальної
              підготовки. Сучасні методики, досвідчені інструктори, гарантований
              результат.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Оберіть програму навчання
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Від базового курсу для новачків до спеціалізованих програм
            ...
            <Card className="bg-gradient-to-r from-gray-50 to-white border-0 shadow-xl">
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                  Наші консультанти допоможуть підібрати програму, що найкраще
                  відповідає вашим потребам та рівню підготовки.
                </p>
